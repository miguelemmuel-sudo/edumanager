...
html = html.replace(/value="Collège Saint-Joseph"/g, 'value=""');
html = html.replace(/value="contact@saint-joseph\.ci"/g, 'value=""');
html = html.replace(/value="\+225 27 00 00 00"/g, 'value=""');
html = html.replace(/value="Côte d'Ivoire"/g, 'value=""');
html = html.replace(/value="Abidjan"/g, 'value=""');
html = html.replace(/value="Cocody, Rue des Jardins"/g, 'value=""');
html = html.replace(/value="https:\/\/saint-joseph\.ci"/g, 'value=""');
html = html.replace(/value="2025-2026"/g, 'value=""');
